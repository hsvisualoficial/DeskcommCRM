...
-- Extensões usadas pelos tipos/índices abaixo (citext em organizations.slug,
-- vector em ai_chunks.embedding + índice ivfflat, pg_trgm nos índices gin).
-- Não estavam declaradas no dump original; adicionadas aqui pra baseline
-- rodar do zero num banco novo.
